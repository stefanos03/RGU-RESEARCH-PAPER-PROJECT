...
?>  
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="text-left price-headline" style="color:purple;">My Paper Submissions (<?php echo $totalPapers; ?>)</h3>
                </div>
              ...
              <div class="row" >
                  ...
                  <div class="col-xs-4">
                        <?php  
                            echo "<i class='fa fa-comment-o'></i> <a href='submited_paper_info.php?pid=".$row['id']."'>".$row['title']."</a><br/>";
                        ?>
                  </div>
                  <div class="col-xs-4">
                      <?php
